...
public class CarConfiguration : IEntityTypeConfiguration<Car>
{
    ...
    private void ConfigureCx5(EntityTypeBuilder<Car> builder)
    {
        builder.HasData(new Car
        {
            ...
            ModelChangeFull = new LocalDate(2016, 12, 15),
            ModelChangeLast = new LocalDate(2018, 1, 1),
    ...
    private void ConfigureCorolla(EntityTypeBuilder<Car> builder)
    {
        builder.HasData(new Car
        {
            ...
            ModelChangeFull = new LocalDate(2019, 9, 17),
            ModelChangeLast = new LocalDate(2021, 11, 15),
    ...
    private void ConfigureNsx(EntityTypeBuilder<Car> builder)
    {
        builder.HasData(new Car
        {
            ...
            ModelChangeFull = new LocalDate(2017, 2, 27),
            ModelChangeLast = new LocalDate(2021, 8, 30),
    ...
    private void ConfigureHondaE(EntityTypeBuilder<Car> builder)
    {
        builder.HasData(new Car
        {
            ...
            ModelChangeFull = new LocalDate(2020, 8, 27),
            ModelChangeLast = new LocalDate(2020, 8, 27),
    ...
    private void ConfigureNote(EntityTypeBuilder<Car> builder)
    {
        builder.HasData(new Car
        {
            ...
            ModelChangeFull = new LocalDate(2020, 11, 24),
            ModelChangeLast = new LocalDate(2021, 11, 4),
    ...
    private void ConfigureThree(EntityTypeBuilder<Car> builder)
    {
        builder.HasData(new Car
        {
            ...
            // ImageUrl
            ModelChangeFull = new LocalDate(2019, 9, 26),
            ModelChangeLast = new LocalDate(2019, 9, 26),
            PowerTrain = PowerTrain.ICE,
            DriveSystem = DriveSystem.AWD,
