        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedAt = table.Column<Instant>(type: "timestamp with time zone", nullable: true, comment: "削除日時"),
                    CreatedAt = table.Column<Instant>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()", comment: "作成日時"),
                    UpdatedAt = table.Column<Instant>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()", comment: "更新日時"),
                    ...
                    ModelChangeFull = table.Column<LocalDate>(type: "date", nullable: true, comment: "フルモデルチェンジ時期(日本)"),
                    ModelChangeLast = table.Column<LocalDate>(type: "date", nullable: true, comment: "最終モデルチェンジ時期(日本)"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "434d352d-3cf3-466b-813c-a685b466ffa7", "3a189fc0-ade7-4a06-959b-c8ffefa44883", "Administrator", "ADMINISTRATOR" },
                    { "dea42f26-4236-4f0f-b0e4-401726b43db3", "96a7c34e-4c37-441d-8bc5-eb83d48f4f87", "Viewer", "VIEWER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "ベンチレーテッドディスク", "ディスク", null, 4, new[] { "ミラーサイクルエンジン", "アイドリングストップ機構", "筒内直接噴射", "可変バルブタイミング", "気筒休止", "充電制御", "ロックアップ機構付トルクコンバーター", "電動パワーステアリング" }, "25S Proactive", "https://upload.wikimedia.org/wikipedia/commons/8/85/2017_Mazda_CX-5_%28KF%29_Maxx_2WD_wagon_%282018-11-02%29_01.jpg", "マツダ", new NodaTime.LocalDate(2016, 12, 15), new NodaTime.LocalDate(2018, 1, 1), "6BA-KF5P", "CX-5", 0, 3140500, "ラック&ピニオン式", "マクファーソンストラット式", "マルチリンク式", "https://www.mazda.co.jp/cars/cx-5/", 4, 1690, 4545, 210, 1595, 1595, 8, 1620, 2700, 1840, 55, 225, 19, 55, 225, 19, 89f, "PY-RPS", 13f, 0, 4, 2.488f, "DI", 58, 1, 138f, 6000, 6000, 250f, 4000, 4000, 100f, "水冷直列4気筒DOHC16バルブ", 3, 1265, 1890, null, 5, 1540, null, null, null, null, null, null, 14.2f, 13f, null, 14.7f, 10.2f, 13.4f, 5.5f, null, null, 3.893f, new[] { 3.552f, 2.022f, 1.452f, 1f, 0.708f, 0.599f }, 4.624f, 2.928f, 0 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, "ベンチレーテッドディスク", "ディスク", null, 4, new[] { "ハイブリッドシステム", "アイドリングストップ装置", "可変バルブタイミング", "電動パワーステアリング", "充電制御", "電気式無段変速機" }, "HYBRID G-X E-Four", "https://upload.wikimedia.org/wikipedia/commons/8/8a/Toyota_COROLLA_TOURING_HYBRID_W%C3%97B_2WD_%286AA-ZWE211W-AWXSB%29_front.jpg", "トヨタ", new NodaTime.LocalDate(2019, 9, 17), new NodaTime.LocalDate(2021, 11, 15), "6AA-ZWE214W-AWXNB", "カローラツーリング", 1, 2678500, null, "マクファーソンストラット式コイルスプリング", "ダブルウィッシュボーン式コイルスプリング", "https://toyota.jp/corollatouring/", 6.5f, null, "ニッケル水素電池", null, 4, 1460, 4495, 130, 1530, 1540, 7, 1410, 2640, 1745, "1NM", 53f, null, null, 163f, null, null, "動力前用", null, "交流同期電動機", "1MM", 5.3f, null, null, 55f, null, null, "動力後用", null, "交流同期電動機", 65, 195, 15, 65, 195, 15, 80.5f, "2ZR-FXE", null, 0, 4, 1.797f, "電子制御式燃料噴射装置(EFI)", 43, 1, 72f, 5200, 5200, 142f, 3600, 3600, 88.3f, "直列4気筒 DOHC 16バルブ VVT-i ミラーサイクル", 3, 1160, 1790, null, 5, 1510, null, null, null, null, null, null, 31f, 26.8f, null, 26.8f, 25.1f, 28.1f, 5f, null, null, null, null, 2.834f, 10.487f, 5 },
                    { 3, "油圧式ベンチレーテッドディスク", "油圧式ベンチレーテッドディスク", null, 4, new[] { "ハイブリッドシステム", "直噴エンジン", "可変バルブタイミング", "アイドリングストップ装置", "電動パワーステアリング" }, "Type S", "https://upload.wikimedia.org/wikipedia/commons/e/ea/2019_Honda_NSX_3.5_CAA-NC1_%2820190722%29_01.jpg", "ホンダ", new NodaTime.LocalDate(2017, 2, 27), new NodaTime.LocalDate(2021, 8, 30), "5AA-NC1", "NSX", 2, 27940000, "ラック&ピニオン式(電動パワーステアリング仕様)", "ダブルウィッシュボーン式", "ウィッシュボーン式", "https://www.honda.co.jp/NSX/types/", null, 72, "ニッケル水素電池", null, 2, 1215, 4535, 110, 1665, 1635, 6, 1790, 2630, 1940, "H3", 27f, 4000, 4000, 73f, 0, 2000, "動力前用", null, "交流同期電動機", "H2", 35f, 3000, 3000, 148f, 500, 2000, "動力後用", null, "交流同期電動機", 35, 245, 19, 30, 305, 20, 91f, "JNC", 10f, 1, 6, 3.492f, "電子制御燃料噴射式(ホンダ PGM-FI)", 59, 2, 389f, 6500, 6850, 600f, 2300, 6000, 89.5f, "水冷V型6気筒縦置", 3, null, null, null, 2, null, null, null, null, null, null, null, null, 10.6f, null, 11.4f, 7.8f, 12.1f, 5.9f, null, null, null, new[] { 3.838f, 2.433f, 1.777f, 1.427f, 1.211f, 1.038f, 0.88f, 0.747f, 0.633f }, 10.382f, 3.583f, 1 }
                });
