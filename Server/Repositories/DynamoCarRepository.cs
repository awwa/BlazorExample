...
public class DynamoCarRepository : IDynamoCarRepository
{
    ...
    private async Task<List<string>> queryByRangeAsync(string dataType, Range range)
    {
        var request = new QueryRequest()
        {
            TableName = TABLE_NAME,
    ...
    public class CarQuery
    {
        ...
        /// 小売価格(税込/円)
        /// </summary>
        public Range Price { get; set; } = new Range();
        /// <summary>
        /// パワートレイン
        /// </summary>
        ...
        /// 全長(mm)
        /// </summary>
        public Range BodyLength { get; set; } = new Range();
        /// <summary>
        /// 全幅(mm)
        /// </summary>
        public Range BodyWidth { get; set; } = new Range();
        /// <summary>
        /// 全高(mm)
        /// </summary>
        public Range BodyHeight { get; set; } = new Range();
        /// <summary>
        /// 車両重量(kg)
        /// </summary>
        public Range Weight { get; set; } = new Range();
        /// <summary>
        /// ドア数
        /// </summary>
        public Range DoorNum { get; set; } = new Range();
        /// <summary>
        /// 乗車定員(人)
        /// </summary>
        public Range RidingCap { get; set; } = new Range();
        /// <summary>
        /// 燃料消費率WLTCモード(km/L)
        /// </summary>
        public Range FcrWltc { get; set; } = new Range();
        /// <summary>
        /// 燃料消費率JC08モード(km/L)
        /// </summary>
        public Range FcrJc08 { get; set; } = new Range();
        /// <summary>
        /// 一充電走行距離WLTCモード(km)
        /// </summary>
        public Range MpcWltc { get; set; } = new Range();
        /// <summary>
        /// 交流電力消費率WTLCモード(Wh/km)
        /// </summary>
        public Range EcrWltc { get; set; } = new Range();
        /// <summary>
        /// 交流電力消費率JC08モード(Wh/km)
        /// </summary>
        public Range EcrJc08 { get; set; } = new Range();
        /// <summary>
        /// 一充電走行距離JC08モード(km)
        /// </summary>
        public Range MpcJc08 { get; set; } = new Range();
        /// <summary>
        /// 使用燃料種類
        /// </summary>
