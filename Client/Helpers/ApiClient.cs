...
namespace HogeBlazor.Client.Helpers
{
    ...
    public partial class CarsClient 
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.IDictionary<string, CarDto>> QueryCarsAsync(System.Collections.Generic.IEnumerable<string> makerNames, int? price_Lower, int? price_Upper, string powerTrain, string driveSystem, string bodyType, int? bodyLength_Lower, int? bodyLength_Upper, int? bodyWidth_Lower, int? bodyWidth_Upper, int? bodyHeight_Lower, int? bodyHeight_Upper, int? weight_Lower, int? weight_Upper, int? doorNum_Lower, int? doorNum_Upper, int? ridingCap_Lower, int? ridingCap_Upper, int? fcrWltc_Lower, int? fcrWltc_Upper, int? fcrJc08_Lower, int? fcrJc08_Upper, int? mpcWltc_Lower, int? mpcWltc_Upper, int? ecrWltc_Lower, int? ecrWltc_Upper, int? ecrJc08_Lower, int? ecrJc08_Upper, int? mpcJc08_Lower, int? mpcJc08_Upper, string fuelType)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.IDictionary<string, CarDto>> QueryCarsAsync(System.Collections.Generic.IEnumerable<string> makerNames, int? price_Lower, int? price_Upper, string powerTrain, string driveSystem, string bodyType, int? bodyLength_Lower, int? bodyLength_Upper, int? bodyWidth_Lower, int? bodyWidth_Upper, int? bodyHeight_Lower, int? bodyHeight_Upper, int? weight_Lower, int? weight_Upper, int? doorNum_Lower, int? doorNum_Upper, int? ridingCap_Lower, int? ridingCap_Upper, int? fcrWltc_Lower, int? fcrWltc_Upper, int? fcrJc08_Lower, int? fcrJc08_Upper, int? mpcWltc_Lower, int? mpcWltc_Upper, int? ecrWltc_Lower, int? ecrWltc_Upper, int? ecrJc08_Lower, int? ecrJc08_Upper, int? mpcJc08_Lower, int? mpcJc08_Upper, string fuelType, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
